<%-- Created by IntelliJ IDEA. User: brian Date: 10/20/2023 Time: 3:50 PM To
          ...
          <tr>
            ...
            <td>
              <div class="flex items-center space-x-3">
                ...
                <div class="max-w-xs">
                  <div class="truncate">
                    <div class="font-bold">Yahahaha</div>
            ...
            <td>
              Motorcycle
              <br />
              <span class="badge badge-ghost badge-sm">ID: xxx</span>
            </td>
            <td>2023-10-11</td>
            <td>51.000.000d</td>
          </tr>
