            ...
            <div>
              <div class="flex flex-col gap-y-5">
                ...
                <div class="flex">
                  ...
                  <select class="select select-bordered w-full max-w-xs rounded-none" name="whichCategory" id="whichCategory">
                ...
                <div class="flex">
                  ...
                  <input type="number" id="productPrice" name="productPrice"
                         ...
                         placeholder="Product price" required min="1"/>
                </div>
                <div class="flex">
                  <div class="w-[150px] flex justify-end mr-7 grow-0">
                    <label for="productDescription" class="label">Description</label>
                  </div>
                  <textarea id="productDescription" class="textarea textarea-info grow rounded-none" placeholder="Product description" name="productDescription"></textarea>
                </div>
