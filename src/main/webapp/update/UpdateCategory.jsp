                        ...
                        <div>
                            <div class="flex flex-col gap-y-5">
                                ...
                                <div class="flex">
                                    ...
                                    <select
                                            class="select select-bordered rounded-none w-full max-w-xs" id="catStatus">
                                ...
                                <div class="flex">
                                    <div class="w-[150px] flex justify-end mr-7 grow-0">
                                      <label for="categoryDescription" class="label">Description</label>
                                    </div>
                                    <textarea id="categoryDescription" class="textarea textarea-info grow rounded-none" placeholder="Product description" name="categoryDescription"></textarea>
                                  </div>
                            </div>
                        </div>
                    </form>
