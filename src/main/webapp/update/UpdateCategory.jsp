...
<div id="page-content" class="ml-64 h-screen flex bg-base-100 items-center justify-center">
                            ...
                            <div class="flex flex-col gap-y-5">
                                <div class="flex">
                                    ...
                                    <input type="text" id="categoryName" name="categoryName"
                                           ...
                                           placeholder="Category name" value="${c.categoryName}"/>
                                </div>
                                <div class="flex">
                                    ...
                                    <select
                                            ...
                                            id="catStatus">
                                        <option value="true" <c:if test="${c.isActive() == true}">
                                            selected</c:if>>Active
                                        </option>
                                        <option value="false" <c:if test="${c.isActive() == false}">
                                            selected</c:if>>Inactive
                                        </option>
                                    </select>
                                </div>
                                <div class="flex">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <div class="avatar">
                            <div class="w-24 rounded-full">
                                <img id="p-img" src="${c.categoryImage}"/>
                            </div>
                        </div>
                        <div x-data>
    ...
    <script>
        ...
        function checkAllInput() {
            if (getCategoryName() == "" || getCategoryDescription() == "" || getCategoryStatus() == "" || getCategoryImage() == "") {
                return false;
            } else {
                return true;
            }
            ...
            if (checkAllInput()) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        htmx.ajax('POST', '${pageContext.request.contextPath}/cartegories-management/submit-update', {
                            swap: 'none', values: {
