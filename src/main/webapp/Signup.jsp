<%-- Created by IntelliJ IDEA. User: brian Date: 10/20/2023 Time: 4:24 PM To change this template use File | Settings |
  ...
  <%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body class="w-screen h-screen flex justify-center items-center overflow-x-hidden">
      <div class="card w-full max-w-[35rem] shadow-2xl bg-base-100">
        <div class="card-body">
          ...
          <div class="form-control">
            ...
            <input type="tel" placeholder="phone number" class="input input-bordered" id="new-phonenum" />
          </div>
          ...
          <div class="flex items-center gap-3">
            <div class="form-control basis-1/2">
              ...
              <input type="text" placeholder="firstname" class="input input-bordered" id="new-fname" />
            </div>
            <div class="form-control basis-1/2">
              <label class="label">
          ...
          <div class="flex pl-1 py-4">
            ...
            <div class="flex gap-4">
              <div class="flex items-center gap-3">
                <input type="radio" name="userGender" class="radio radio-sm checked:bg-blue-500" value="Male" checked
                  id="g-1" />
                <label class="label-text cursor-pointer" for="g-1">Male</label>
              </div>
              <div class="flex items-center gap-3">
                <input type="radio" name="userGender" class="radio radio-sm checked:bg-blue-500" value="Female"
                  id="g-2" />
                <label class="label-text cursor-pointer" for="g-2">Female</label>
              </div>
              <div class="flex items-center gap-3">
                <input type="radio" name="userGender" class="radio radio-sm checked:bg-blue-500" value="Other"
                  id="g-3" />
          ...
          <div class="flex items-center gap-3">
            <div class="form-control basis-1/2">
              ...
              <input type="password" placeholder="password" class="input input-bordered" id="new-password" />
            </div>
            <div class="form-control basis-1/2">
              <label class="label">
                <span class="label-text">Confirm password</span>
                <span class="label-text-alt material-symbols-outlined hidden" id="matchPassword">error</span>
              </label>
              <input type="password" placeholder="confirm password" class="input input-bordered" id="cf-new-password" />
            </div>
          </div>
          ...
          <div class="text-center mt-5">
            ...
            <a href="${pageContext.request.contextPath}/login" class="link link-hover text-blue-600">Sign in</a>
          </div>
        </div>
      </div>
