          ...
          <div class="grid grid-cols-2 mt-8">
            ...
            <div class="w-full h-full flex justify-center">
              <div class="max-w-[80%] max-h-full mt-4 lg:row-span-3 lg:mt-0 flex-grow">
                ...
                <p class="text-3xl tracking-tight text-gray-900">[Mã ELBAU5 giảm 5% đơn 300K] Máy lọc không khí LG Puricare 360 Hit AS60GHWG0, lọc bụi mịn PM0.01, kháng khuẩn 99.9%</p>
