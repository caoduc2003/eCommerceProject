                  ...
                  <div class="w-full h-full">
                    ...
                    <div class="name-section flex items-center gap-4 mt-7">
                      ...
                      <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Lastname" class="input input-bordered w-full" id="last-name" />
                      </div>
                    </div>
                    ...
                    <div class="address-section">
                      ...
                      <div class="flex gap-4">
                        <div class="form-control w-1/3">
                          ...
                          <input type="text" placeholder="Country" class="input input-bordered w-full" id="country" />
                        </div>
                        <div class="form-control w-1/3">
                          <label class="label">
                        ...
                        <div class="form-control w-1/3">
                          ...
                          <input type="text" placeholder="District" class="input input-bordered w-full" id="district" />
                        </div>
                      </div>
                        ...
                        <label class="card w-[40%] bg-base-200 card-bordered">
                          <div>
                            <input type="radio" name="transport-unit"
                              class="absolute top-4 right-4 radio radio-sm radio-primary" value="${tu.transportUnitID}"
                    ...
                    <div>
                      ...
                      <div class="pt-7">
                        <div class="form-control bg-base-200 rounded-lg h-16">
                          <label class="label cursor-pointer gap-4 items-center h-full" style="justify-content: normal">
                            <input type="radio" name="payment-method" class="radio checked:bg-red-500" value="QR" />
                            <div class="flex gap-2 items-center">
                              <div class="w-14 h-6 flex items-center">
                                <img src="./asset/images/Checkout/Payment_method/Logo VNPAY-QR.svg" alt="VNPay_QR" />
                              </div>
                        ...
                        <div class="form-control bg-base-200 rounded-lg h-16">
                          <label class="label cursor-pointer gap-4 items-center h-full" style="justify-content: normal">
                            <input type="radio" name="payment-method" class="radio checked:bg-blue-500" value="COD" />
                            <div class="flex gap-2 items-center">
                          ...
                          <div class="flex flex-col grow">
                            <div class="flex justify-between h-1/2">
                              <div>
                                ...
                                <p class="truncate max-w-[300px]" title="${item.product.productDescription}">
