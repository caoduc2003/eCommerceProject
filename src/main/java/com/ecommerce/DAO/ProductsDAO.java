        ...
        try {
            if (connection != null) {
                ...
                while (rs.next()) {
                    ...
                    Products product = new Products(productID, productName, productDescription, productImage, productPrice, categoryID ,null);
        ...
        try {
            ...
            if (connection != null) {
                ...
                if (rs.next()) {
                    ...
                    productResult = new Products(productID, productName, productDescription, productImage, productPrice, categoryID , null);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
